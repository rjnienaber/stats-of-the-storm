...
class Sidebar extends BasePage  {
  ...
  async navigateToMatches() {
    ...
    debug('wait for matches page to be visible');
  ...
  async navigateToAbout() {
    ...
    await this.click("#main-menu a[section-name=about]")

    debug('wait for about page to be visible');
    await this.browser.waitForVisible("#about-page-content");

    return new AboutPage(this.app, this);
  }
}
